      ...
      <div class="invoice-container">
        ...
        <div class="summary-section">
          ...
          <div class="summary-row">
            ...
            <span>${formatPrice(order.shipping || 0)} VNĐ</span>
          </div>
          <div class="summary-row">
            <span>Giảm giá:</span>
            <span>${formatPrice((order.subtotal || 0) + (order.shipping || 0) - (order.total || 0))} VNĐ</span>
          </div>
...
export const emailInvoice = async (order: Order, email: string) => {
  try {
