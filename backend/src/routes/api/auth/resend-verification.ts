...
import { validateEmail as validateEmailField, sanitizeString } from '../services/validation'
import { findTempUserByEmail, updateTempUser } from '../services/database'
import { queueVerificationEmail } from '../services/emailQueue'
import { generateVerificationCode, getCodeExpirationTime, checkRateLimit } from '../services/auth'
import { isVerificationValid } from '../services/verificationUtils'
